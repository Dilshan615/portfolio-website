...
const PROJECTS_DATA = [
  ...
  },
  {
    ...
    description:
      "Modern, animated portfolio template perfect for showcasing your work and skills",
    price: 99,
  ...
  },
  {
    ...
    category: "app",
    tech: ["Python", "MySQL", "JavaScript", "CSS"],
    features: [
      "Real-time Sync",
      "Team Collaboration",
      "Analytics Dashboard",
  ...
  },
  {
    ...
    description:
      "Complete reservation system with table management, customer notifications, and reporting",
    price: 349,
  ...
  },
  {
    ...
    description:
      "Cross-platform fitness app with workout tracking, nutrition logging, and progress charts",
    price: 279,
...
function renderProjects(
  ...
  container.innerHTML = projects
    ...
    <div class="project-card" data-category="${project.category}" data-project-id="${project.id}">
      <img src="${imageBasePath}${project.image}" alt="${project.title}" class="project-image" onerror="this.src='${imageBasePath}assets/img/placeholder.jpg'">
      <div class="project-info">
        ...
        <div class="project-meta">
          ...
          <button class="btn btn-sm btn-secondary" onclick="viewProjectDetails(${project.id}, '${imageBasePath}')">
            Details
          </button>
        </div>
...
function viewProjectDetails(projectId, imageBasePath = '') {
  const project = PROJECTS_DATA.find((p) => p.id === projectId);
  if (!project) return;
  ...
  modal.innerHTML = `
    <div class="modal-content" style="max-width: 800px;">
      ...
      <img src="${imageBasePath}${project.image}" alt="${project.title}" style="width: 100%; height: 300px; object-fit: cover; border-radius: 12px; margin-bottom: 1.5rem;" onerror="this.src='${imageBasePath}assets/img/placeholder.jpg'">
...
function initShop() {
  ...
  if (searchInput) {
    searchInput.addEventListener(
      "input",
      window.portfolioMarketplace.debounce((e) => {
        const category =
